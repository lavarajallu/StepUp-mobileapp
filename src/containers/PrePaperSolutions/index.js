...
class PrePaperSolutions extends Component{
    constructor(props){
        super(props)
        this.state={
            selectedItem:data[0],
    ...
    componentDidMount() {
       ...
       getDataquestions(user,token){
        ...
        var url =baseUrl+"/user-previous-test/"+this.props.testid
        ...
        alignSelf: 'flex-start',}} html={this.state.selectedItem.question.solution} /></View>
            ...
            <Text>Loading......</Text></View>}
              ...
              justifyContent:"center",alignItems:"center"}} onPress={this.onPrevious.bind(this)}>
                  ...
                  <Text style={{ textAlign:"center",fontSize:12,color:colors.Themecolor}}>Done</Text>
                      </TouchableOpacity> :
                       <TouchableOpacity style={{height:30,width:100,borderRadius:20,backgroundColor:"white",paddingHorizontal:10,
...
export default PrePaperSolutions;