          ...
          <>
            ...
            <View style={{flex:1,padding:0}}>
              ...
              <Text style={{color:"white",textAlign:"center",marginBottom:10,fontSize:15}}>{testResult.wrong_ans_count?testResult.wrong_ans_count:0}</Text>
                ...
                <Text style={{marginTop:10,textAlign:"center",fontSize:13}}>Lightning Fast: {testResult.lightening_count?testResult.lightening_count:0}</Text>
                <Text style={{marginTop:10,textAlign:"center",fontSize:13}}>What a Timing/Shot: {testResult.shot_count?testResult.shot_count:0}</Text>
                <Text style={{marginTop:10,textAlign:"center",fontSize:13}}>Extra Innings: {testResult.extra_inning_count?testResult.extra_inning_count:0}</Text>
                </View>
                  <View style={{flex:0.5,justifyContent:"space-evenly",marginLeft:-50}}>
                  <Text style={{marginTop:10,textAlign:"center",fontSize:13}}>Lost: {testResult.lost_count?testResult.lost_count:0}</Text>
                  ...
                  <Text style={{marginTop:10,textAlign:"center",fontSize:13}}>Un Answered: {testResult.un_ans_count?testResult.un_ans_count:0}</Text>
                  </View>
                </View>
