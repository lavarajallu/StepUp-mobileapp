...
class PrePaperAssesment extends Component{
    ...
    render(){
        return(
            ...
            <Text style={styles.toptext}>Mathematics JEE Mains 2020</Text>
            </View>
        ...
        <Image source={require('../../assets/images/modalpapercross.png')} style={{width:25,height:25,alignSelf:"flex-end",}}/>
         ...
         <Image source={require("../../assets/images/modalpapericon.png")} style={{width:301/3,height:265/3,alignSelf: 'center',tintColor: colors.Themecolor}}/>
          <Text style={{fontSize: 20,textAlign: 'center',marginTop:10}}>Are you sure you want to submit assesment?</Text>
         <View style={{flexDirection:'row',justifyContent:"space-around",marginTop:20 }}>
           <TouchableOpacity onPress={this.onCancel.bind(this)} >
             <View  style={{width:265/2.2,height:108/2.2,justifyContent:"center",borderRadius: 25,alignItems:"center",borderWidth:1,borderColor:colors.Themecolor}}>
                <Text style={{color:colors.Themecolor}}>CANCEL</Text>
             </View>
           </TouchableOpacity>
             <TouchableOpacity onPress={this.onsubmitmodal.bind(this)}>
          <View style={{width:256/2,height:103/2,justifyContent:"center",borderRadius: 25,alignItems:"center",backgroundColor: colors.Themecolor}}>
