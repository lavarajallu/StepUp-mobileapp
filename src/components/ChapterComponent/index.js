...
class ChapterComponent extends Component {
    ...
    renderItem({ item, index }) {
        console.log("newitemmmmm", this.props.userData)
        // CBSE_GR_10_BIO
        // CBSE_GR_10_BIO
        ...
        return (
            index === 0 ?
                ...
                <TouchableOpacity onPress={this.onItem.bind(this, item)} style={{
                    borderWidth: 0, borderColor: "lightgrey", height: 80, width: windowWidth / 1.15, alignSelf: "center",
                ...
                this.props.validpackages && this.props.validpackages[this.props.userData.reference_id] ? 
                <TouchableOpacity onPress={this.onItem.bind(this, item)} style={{
                    borderWidth: 0, borderColor: "lightgrey", height: 80, width: windowWidth / 1.15, alignSelf: "center",
                    backgroundColor: 'white', borderWidth: 1,
                    borderRadius: 5,
               ...
               <>
                ...
                <TouchableOpacity onPress={this.onlock.bind(this)} style={{
                    borderWidth: 0, borderColor: "lightgrey", position:"absolute",
                    height: 80, width: windowWidth / 1.15, alignSelf: "center",
                    backgroundColor: 'rgba(1, 1, 1, 0.2)', borderWidth: 1,
                    borderRadius: 5,
                    borderColor: '#ddd',
                    borderBottomWidth: 0,
                    shadowColor: '#000000',
                    ...
                    <Image source={require('../../assets/images/padlock.png')} style={{width:30,height:30,alignSelf:"center",
                        tintColor:"grey"}}/>
                </TouchableOpacity>
                </>
        ...
        return (
            chapters.length > 0 ?
                <View style={{ flex: 1, padding: 20 }}>
                    {userDetails.user_role === "General Student" ? 
