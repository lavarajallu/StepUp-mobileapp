...
textmain:{
color:'#695276',textAlign: 'center', fontSize:20,
},
rectview:{
  width: windowWidth/2.2,height:1340/10,justifyContent:"center",
      backgroundColor: 'white',borderRadius: 10,margin:5,overflow:"hidden",
        // shadowOffset: { width: 0, height: 5 },
        // shadowOpacity: 1,
        // shadowRadius: 5,
        // elevation: 10,
      ...
      topsubview:{
        flex:0.5,flexDirection:"row",justifyContent:"space-evenly",paddingHorizontal:10,alignItems:"center"
      },
      bottomsubview:{
        flex:0.5,justifyContent:"space-around"
      },
      subjectname:{
        color:"#4b4b4b",fontSize:12,textAlign: 'center',color:"white",paddingHorizontal:10,flexWrap:"wrap"
      },
      progressview:{
        marginHorizontal: 10
      },
